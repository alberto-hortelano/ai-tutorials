...
const _MODULE_META: Record<Lang, Record<string, string>> = {
  es: {
    mod1: 'Semanas 1-2 \u00b7 PS1',
    mod2: 'Semanas 3-4 \u00b7 PS2',
    mod3: 'Semanas 3-4 \u00b7 PS3',
    mod4: 'Semanas 3-4 \u00b7 PS3',
    mod5: 'Semanas 5-8',
    mod6: 'Semanas 9-10 \u00b7 PS4',
...
const _LESSONS_BASE: LessonBase[] = [
  ...
  { id: 'kl-divergence-mle', module: 'mod1', num: 2, ready: true,
    ...
    tags: [{ label: 'PS1', type: 'ps' }, { label: 'Fundamentos', type: 'topic' }] },
  ...
  { id: 'modelos-autoregresivos', module: 'mod1', num: 4, ready: true,
    ...
    tags: [{ label: 'PS1', type: 'ps' }, { label: 'Autoregresivos', type: 'topic' }] },
  ...
  { id: 'variables-latentes', module: 'mod2', num: 6, ready: true,
    ...
    tags: [{ label: 'PS2', type: 'ps' }, { label: 'VAE', type: 'topic' }] },
  ...
  { id: 'cambio-de-variables', module: 'mod3', num: 12, ready: true,
    ...
    tags: [{ label: 'PS3', type: 'ps' }, { label: 'Flows', type: 'topic' }] },
  ...
  { id: 'gans-min-max', module: 'mod4', num: 15, ready: true,
    ...
    tags: [{ label: 'PS3', type: 'ps' }, { label: 'GANs', type: 'topic' }] },
  ...
  { id: 'score-matching', module: 'mod5', num: 21, ready: true,
    ...
    tags: [{ label: 'PS4', type: 'ps' }, { label: 'Score', type: 'topic' }] },
  ...
  { id: 'proceso-difusion', module: 'mod6', num: 22, ready: true,
    ...
    tags: [{ label: 'PS4', type: 'ps' }, { label: 'Difusión', type: 'topic' }] },
