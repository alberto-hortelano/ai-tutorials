...
- [GAN: Juego Minimax](/interactives/gan_juego_minimax.html) — Visualiza la dinamica de entrenamiento del generador y discriminador
- [Discriminador Optimo](/interactives/discriminador_optimo.html) — Explora D* optimo y los logits h* para distintas distribuciones
- [Wasserstein vs KL vs JSD](/interactives/wasserstein_vs_kl.html) — Compara como se comportan las distintas metricas cuando las distribuciones se separan
- [Conditional GAN](/interactives/conditional_gan.html) — Demo del projection discriminator para generacion condicionada a clase
