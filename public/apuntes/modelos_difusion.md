...
- [Proceso de Difusion](/interactives/proceso_difusion.html) — Visualiza el forward process (aniadir ruido) paso a paso con distintos schedules
- [DDPM vs DDIM](/interactives/ddpm_vs_ddim.html) — Compara el sampling estocastico (DDPM) vs determinista (DDIM) con distinto numero de pasos
- [Campo de Score](/interactives/campo_score.html) — Visualiza el campo vectorial del score para distintas distribuciones
